...
#### Smoked Salmon Hor d'oeuvre
- Spelling of Hors-d'oeuvre
- last ingredient -"1/2 lb smoked salmon or LOX cut ... (not box)

### Page 13
#### Favourite Cheese Ball
- Change order of ingredients
...
#### Oatmeal Cookies (Meal in a Cookie)
Missing one line of instructions. "Add to flour mixture." goes before "Shape with spoon ..."
...
#### Weazie's Ham Ball
 - should be moved from "Main Dishes" to "Appetizers"

### Page 93

#### Persneskt Lamb
 - Cloves in the ingredient list should be changed to 2
 - At the end "Other preparation method. Just PLACE all the ingredients ...

### Page 94

#### Hot Stuffed Avocados With Creamed Chicken
 - Punctuation, 3rd line, should have a period instead of a comma "juice and garlic from avocados (PERIOD) Fill ..)

### Page 104

#### Quick Dills
 - In the method, wash "cucumbers" (not dills) and prick ...
 - Replace all instances of cucs with cucumbers

### Page 108

#### Pat's Saskatoon Pie
- last ingredient should have a space before "butter"
- 2nd line of instructions change "of" to "or", i.e. cover with a top crust OR with a latiice
- Change order of ingredients
  ...
  - 1 - 2 tbsp butter
#### Pat's Saskatoon Pie - Pie Crust
- can be omitted since it is the same as Basic Pie Dough, p.105

### Page 118

#### Caprese Salad (Italian)
- Spelling of "vinegar" in ingredient list.
...
#### Butter Sauce
- should be moved from "Sauces" to "Dessert Sauces"

### Page 128

#### Rainbow Slice
- Add McTurk to Beth Seale's name both in Table of Contents and in Recipe header.
...
#### Mrs. Hunter's Turnip Casserole
- Change comma to period after hr in last line of instructions. "for 1 hr. and heat."
- Change ingredients to:
  - 2 - 3 med. turnips
